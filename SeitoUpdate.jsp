     ...
     <!-- Logo -->
        ...
        <div class="content-wrapper">
            ...
            <section class="content-header">
                <h1><a type="button" class="btn btn-default btn-sm" href="/BBM/SeitoList.jsp"><b>戻る</b></a>
                </h1>
    ...
    <!-- =============================================== -->
	  ...
	  while(rs.next()){
		...
		%>  
            ...
            <div class="row">
                <div class="col-xs-12">
                   <form method="post" action="./SeitoUpdate?seitoID=<%=rs.getString("seitoID")%>" class="form-horizontal" autocomplete="off">
                            ...
                            <div class="box-body">
                                ...
                                <br>
                                  ...
                                  <div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        <div class="row"><div class="col-sm-8"><input type="text" value="<%=rs.getString("sname")%>" name="sname" class="form-control input-sm" placeholder="（例）　山田　太郎" required/></div></div>
                                 ...
                                 <div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        <div class="row"><div class="col-sm-8"><input type="text" value="<%=rs.getString("skana")%>" name="skana"class="form-control input-sm" placeholder="（例）　ヤマダ　タロウ"/></div></div>
                                        <!--<div class="row"><div class="col-sm-10"><p class="form-control-static text-danger"><small>ここにエラーメッセージを表示します</small></p></div></div>-->
                                    </div>
                                </div>
                                 <div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        ...
                                        <div class="row"><div class="col-sm-12">
                                            ...
                                            <label><input type="radio" name="sex" value="女" <% if(rs.getString("sex").equals("女")){ out.print("checked"); } %>/>女</label>	
                                ...
                                <br>
                                 <div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        <div class="row"><div class="col-sm-8"><input type="text" name="hname" value="<%=rs.getString("hname")%>"class="form-control input-sm" placeholder="（例）　山田　花子" required/></div></div>
                                        <!--<div class="row"><div class="col-sm-10"><p class="form-control-static text-danger"><small>ここにエラーメッセージを表示します</small></p></div></div>-->
                                    </div>
                                </div>
                                 <div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        <div class="row"><div class="col-sm-8"><input type="text" name="hkana" value="<%=rs.getString("hkana")%>"class="form-control input-sm" placeholder="（例）　ヤマダ　ハナコ"/></div></div>
                                        <!--<div class="row"><div class="col-sm-10"><p class="form-control-static text-danger"><small>ここにエラーメッセージを表示します</small></p></div></div>-->
                                    </div>
                                </div>
                               ...
                               <br>
                                 <div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        <div class="row"><div class="col-sm-10"><input type="text" value="<%=rs.getString("home")%>"name="home" class="form-control input-sm" placeholder=""/></div></div>
                                        <!--<div class="row"><div class="col-sm-10"><p class="form-control-static text-danger"><small>ここにエラーメッセージを表示します</small></p></div></div>-->
                                    </div>
                                </div>
                                <br>
                                 <div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        <div class="row"><div class="col-sm-4"><input type="text" name="school" value="<%=rs.getString("school")%>"class="form-control input-sm" placeholder=""/></div></div>
                                        <!--<div class="row"><div class="col-sm-10"><p class="form-control-static text-danger"><small>ここにエラーメッセージを表示します</small></p></div></div>-->
                                    </div>
                                </div>
                                    ...
                                    <div class="col-sm-10">
                                        <div class="row"><div class="col-sm-4">
                                            <select name="age" class="form-control input-sm">
                                            	<option value="小学４年"<% if(rs.getString("age").equals("小学４年")){ out.print("selected"); } %>>小学４年</option>
                                            	<option value="小学５年"<% if(rs.getString("age").equals("小学５年")){ out.print("selected"); } %>>小学５年</option>
                                                <option value="小学６年"<% if(rs.getString("age").equals("小学６年")){ out.print("selected"); } %>>小学６年</option>
                                                <option value="中学１年"<% if(rs.getString("age").equals("中学１年")){ out.print("selected"); } %>>中学１年</option>
                                                <option value="中学２年"<% if(rs.getString("age").equals("中学２年")){ out.print("selected"); } %>>中学２年</option>
                                                <option value="中学３年"<% if(rs.getString("age").equals("中学３年")){ out.print("selected"); } %>>中学３年</option>
                                                <option value="高校生"<% if(rs.getString("age").equals("高校生")){ out.print("selected"); } %>>高校生</option>
                                ...
                                <br>
                                 <div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        <div class="row"><div class="col-sm-12">
                                            <div class="radio">
                                                <label><input type="radio" name="type" value="集団" checked="checked"/>集団</label>　
                                                <label><input type="radio" name="type" value="個別"<% if(rs.getString("type").equals("個別")){ out.print("checked"); } %>/>個別</label>
                                            </div>
                                        </div></div>
                                        <!--<div class="row"><div class="col-sm-10"><p class="form-control-static text-danger"><small>ここにエラーメッセージを表示します</small></p></div></div>-->
                                    </div>
                                ...
                                <br>
                                    ...
                                    <div class="col-sm-10">
                                        <div class="row"><div class="col-sm-4"><input type="text" name="stel" value="<%=rs.getString("stel")%>"class="form-control input-sm" placeholder="00-0000-0000"/></div></div>
                                        <!--<div class="row"><div class="col-sm-10"><p class="form-control-static text-danger"><small>ここにエラーメッセージを表示します</small></p></div></div>-->
                                    </div>
                                </div>
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        <div class="row"><div class="col-sm-4"><input type="text" name="htel" value="<%=rs.getString("htel")%>"class="form-control input-sm" placeholder="00-0000-0000"/></div></div>
                                        <!--<div class="row"><div class="col-sm-10"><p class="form-control-static text-danger"><small>ここにエラーメッセージを表示します</small></p></div></div>-->
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        <div class="row"><div class="col-sm-4"><input type="text" name="tel" value="<%=rs.getString("tel")%>"class="form-control input-sm" placeholder="00-0000-0000" required/></div></div>
                                        <!--<div class="row"><div class="col-sm-10"><p class="form-control-static text-danger"><small>ここにエラーメッセージを表示します</small></p></div></div>-->
                                    </div>
                                </div>
                                <br>
                                    ...
                                    <div class="col-sm-10">
                                        ...
                                        <i class="fa fa-envelope"></i></span><input type="text" name="smail" value="<%=rs.getString("smail")%>"
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        <div class="row"><div class="col-sm-8"><div class="input-group"><span class="input-group-addon">
                                        <i class="fa fa-envelope"></i></span><input type="text" name="hmail" value="<%=rs.getString("hmail")%>"
                                        class="form-control input-sm" placeholder=""/></div></div></div>
                                        <!--<div class="row"><div class="col-sm-10"><p class="form-control-static text-danger"><small>ここにエラーメッセージを表示します</small></p></div></div>-->
                                    </div>
                                </div>
               ...
               <br> 
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                                                                  <div class="row"><div class="col-sm-12"><textarea rows="5" name="naiyo" class="form-control input-sm"><%=rs.getString("naiyo")%></textarea></div></div>
	              ...
	              <a class="btn btn-app"href="./SeitoList.jsp">            
