  ...
  <body class="hold-transition skin-green sidebar-mini">
    ...
    <header class="main-header">
     <!-- Logo -->
                ...
                <div class="box-body table-responsive no-padding">
                  ...
                  <table class="table table-hover table-bordered">
                    <tr>
                      ...
                      <th class="active"><center>成績登録</center></th>
                       <th class="active"><center>成績変更</center></th>
                    </tr>
	  ...
	  ResultSet rs=objSql.executeQuery("SELECT * FROM seito_list where age not in ('退塾') order by age");
	  
	  while(rs.next()){
		%>
                                       <tr>
                      <td><%=rs.getString("seitoID")%></td>
                      <td><A class="text-olive" HREF="/BBM/pages/charts/chartjs.jsp?sname=<%=rs.getString("sname")%>"><%=rs.getString("sname")%></A></td>
                      <td><%=rs.getString("school")%></td>
                      <td><%=rs.getString("age")%></td>
                     
                      <td><center><a href="/BBM/RecordInsert.jsp?seitoID=<%=rs.getString("seitoID")%>" class="btn bg-olive btn-xs "><b>登録</b></a></center></td>
                      <td><center><a href="" class="btn btn-default btn-xs"><b>変更</b></a></center></td>
