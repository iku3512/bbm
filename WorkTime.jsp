 ...
 <!-- Tell the browser to be responsive to screen width -->
  ...
  <body class="hold-transition skin-green sidebar-mini">
            ...
            <nav class="navbar navbar-static-top" role="navigation">
                ...
                <div class="collapse navbar-collapse" id="navbar-collapse">
                    ...
                    <ul class="nav navbar-nav">
                        <li><a href="/BBM/WorkTime.jsp">出退勤登録</a></li>
                        <li><a href="/BBM/Details.jsp">明細照会 </a> 
   ...
   <div class="col-md-3 col-sm-6 col-xs-12">
              <div class="info-box">
                <a href="/BBM/WorkTimeList.jsp" class="info-box-icon bg-blue"><span class="fa fa-black-tie"></span></a>
                <div class="info-box-content">
                  <span class="info-box-text text-muted">Attendance</span>
                  <a href="/BBM/WorkTimeList.jsp" class="info-box-number text-black">出退勤登録</a>
            ...
            <div class="col-md-3 col-sm-6 col-xs-12">
              <div class="info-box">
                <a href="/BBM/Details.jsp" class="info-box-icon bg-yellow"><span class="fa fa-file-text-o"></span></a>
                <div class="info-box-content">
                  <span class="info-box-text text-muted">Details</span>
                  <a href="/BBM/Details.jsp" class="info-box-number text-black">明細照会</a>
                </div><!-- /.info-box-content -->
              </div><!-- /.info-box -->
            </div><!-- /.col -->      
