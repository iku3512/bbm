     ...
     <!-- Logo -->
            ...
            <nav class="navbar navbar-static-top" role="navigation">
                ...
                <div class="collapse navbar-collapse" id="navbar-collapse">
                    ...
                    <ul class="nav navbar-nav">
                        <li><a href="/BBM/MakeShift.jsp">シフト作成</a></li>
                        <li class="active"><a href="/BBM/ShiftList.jsp">シフト照会</a></li>
        ...
        <div class="content-wrapper">
            ...
            <section class="content-header">
                <h1>シフト表　<a type="button" class="btn btn-default btn-sm" href="/BBM/pages/ShiftCalendar.jsp"><b>戻る</b></a></h1>
                
                <!-- パンくず -->
                <ol class="breadcrumb">
                    <li><a href="">シフト作成</a></li>
                    <li>シフト表</li>
                    <li><%= request.getParameter("day") %></li>
                </ol>
            </section>
      ...
      <!-- Content Wrapper. Contains page content -->
            ...
            <div class="row">
                <div class="col-xs-12">
                  ...
                  <FONT style='font-size : 18px; color : #666666'><%= request.getParameter("day") %></FONT>
                  
                  			<form method="post" action="./ShiftDateSrch.jsp" class="form-horizontal" autocomplete="off">
                   			 <div class="input-group pull-right" style="width: 200px;">
                     			 <input type="date" name="day" class="form-control input-sm pull-right" 
                     			 value="<%= request.getParameter("day") %>">
	  ...
	  ResultSet rs=objSql.executeQuery("SELECT * FROM Shift_list where date like '%" + request.getParameter("day") + "%' order by time1");
	  ...
	  while(rs.next()){
		...
		%>
                                     ...
                                     <tr>
                      <td class="success"><center><%=rs.getString("kname")%></center></td>
                      <td class="active"><%=rs.getString("time1")%></td>
                      <td class="active"><%=rs.getString("time2")%></td>
                      <td><%=rs.getString("stype")%></td>
                      <td><%=rs.getString("subject")%></td>
                      <td><%=rs.getString("snaiyo")%></td>
                      <td><a href="/BBM/ShiftUpdate.jsp?shiftID=<%=rs.getString("shiftID")%>" class="btn btn-default btn-xs"><b>変更</b></a></td>
                      <td><a href="/BBM/ShiftDelete.jsp?shiftID=<%=rs.getString("shiftID")%>" class="btn btn-default btn-xs"><b>消去</b></a></td>
