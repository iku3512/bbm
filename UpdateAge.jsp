  ...
  <body class="hold-transition skin-green sidebar-mini">
    ...
    <header class="main-header">
     <!-- Logo -->
                    ...
                    <form method="post" class="form-horizontal">
                        ...
                        <div class="box box-primary">
                         <div class="box-header">
                                <h3 class="box-title"><div class="col-md-1 col-sm-1"><i class="fa fa-fw fa-warning"></i>
                                </div>　学年を繰り上げますか？</h3>
                            </div>
	  ...
	  ResultSet rs=objSql.executeQuery("SELECT seitoID,sname,age FROM seito_list where age not in ('高校生','退塾')");%>
                        
                        
                        <center>						
                        <a class="btn btn-app" href="/BBM/UpdateAge"> 
	                    <i class="fa fa-check" ></i> はい
	                  </a></form>
	                 
	                  
	                   <a class="btn btn-app"href="./EndAge.jsp">            
	                    <i class="fa fa-close" ></i> いいえ
	                  </a>
