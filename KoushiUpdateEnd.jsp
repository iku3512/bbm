     ...
     <!-- Logo -->
        ...
        <div class="content-wrapper">
           ...
           <section class="content-header">
                        <h4>　変更が完了しました。　<a type="button" class="btn btn-default btn-sm" href="/BBM/KoushiList.jsp"><b>戻る</b></a></h4>
  ...
  <!-- col -->
              ...
              <table class="table table-bordered">
               ...
               <table class="table table-bordered">
                ...
                <tbody>
                 <tr>
                     <th width="100" class="success">TEL (携帯)</th>
                    <td width="200"><%=rs.getString("ktel")%></td>
                    <th width="110" class="success">TEL (自宅)</th>
               ...
               <table class="table table-bordered">
                <tbody>
                 <tr>
                     <th width="100" class="success">MAIL</th>
