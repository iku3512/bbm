     ...
     <!-- Logo -->
                ...
                <div class="collapse navbar-collapse" id="navbar-collapse">
                    ...
                    <ul class="nav navbar-nav">
                        ...
                        <li><a href="/BBM/SeitoList.jsp">生徒一覧</a></li>
                                ...
                                <li class="active"><a href="/BBM/EndAge.jsp">学年末処理</a></li>
                            </ul>
                        </li>
                    </ul>
        ...
        <div class="content-wrapper">
            ...
            <section class="content-header">
                <h1>生徒管理　　<a type="button" class="btn btn-default btn-sm" href="/BBM/EndAge.jsp"><b>戻る</b></a>
                </h1>
        ...
        <section class="content">
            <div class="row">
                <div class="col-xs-12">
                  ...
                  <h3 class="box-title">退塾済生徒リスト</h3>
                  
                  
                  		<form method="post" action="./LeftSeitoNameSrch.jsp" class="form-horizontal" autocomplete="off">
                ...
                <div class="box-body table-responsive no-padding">
                  ...
                  <table class="table table-hover">
                    <tr>
                      ...
                      <th class="active">学校</th>
                       <th class="active">ステータス</th>
                      <th class="active">自宅TEL</th>
                      <th class="active">MAIL</th>
                      <th class="active">特記事項</th>
                      <th class="active">入塾</th>
                       <th class="active">消去</th>
                    </tr>
	  ...
	  ResultSet rs=objSql.executeQuery("SELECT * FROM seito_list where age = '退塾'");
	  
	  while(rs.next()){
		%>
                                       <tr>
                      <td><%=rs.getString("seitoID")%></td>
                      <td><A HREF="/BBM/LeftSeitoDetail.jsp?seitoID=<%=rs.getString("seitoID")%>"><%=rs.getString("sname")%></A></td>
                      ...
                      <td><a href="/BBM/SeitoUpdate.jsp?seitoID=<%=rs.getString("seitoID")%>" class="btn btn-primary btn-xs "><b>入塾</b></a></font></td>
        <td><a href="/BBM/SeitoDelete.jsp?seitoID=<%=rs.getString("seitoID")%>" class="btn btn-default btn-xs"><b>削除</b></a></font></td>
                    </tr>
	   <%
	}
	rs.close();
