     ...
     <!-- Logo -->
        ...
        <div class="content-wrapper">
            ...
            <section class="content-header">
                <h1>講師管理　<a type="button" class="btn btn-default btn-sm" href="/BBM/KoushiList.jsp"><b>戻る</b></a></h1>
              ...
              <!-- /.box-header -->
                <div class="box-body table-responsive no-padding">
                  ...
                  <table class="table table-hover">
                     <tr>
                      <th class="active">講師ID</th>
                      <th class="active">講師氏名</th>
	  ...
	  ResultSet rs=objSql.executeQuery("SELECT * FROM koushi_list where kage = '退塾'");
	  ...
	  while(rs.next()){
		%>
                     ...
                     <td><a href="/BBM/KoushiUpdate.jsp?koushiID=<%=rs.getString("koushiID")%>" class="btn btn-warning btn-xs "><b>入塾</b></a></font></td>
        <td><a href="/BBM/KoushiDelete.jsp?koushiID=<%=rs.getString("koushiID")%>" class="btn btn-default btn-xs"><b>削除</b></a></font></td>
                    </tr>
	   <%
	}
	rs.close();
