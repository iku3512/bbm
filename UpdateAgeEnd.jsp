  ...
  <body class="hold-transition skin-green sidebar-mini">
    ...
    <header class="main-header">
     <!-- Logo -->
                    ...
                    <form method="post" class="form-horizontal">
                        ...
                        <div class="box">
                         <div class="box-header">
                                <h3 class="box-title"><div class="col-md-1 col-sm-1">                                
                                </div>学年を更新しました。</h3>
                            </div>
	  ...
	  ResultSet rs=objSql.executeQuery("SELECT seitoID,sname,age FROM seito_list where age not in ('高校生')");%>
                        
                        
                        <center>						
                        <a class="btn btn-app" href="/BBM/EndAge.jsp"> 
	                    <i class="fa fa-edit" ></i>学年末処理へ
	                  </a>
	                 	                  
	                   <a class="btn btn-app"href="./ReUpdateAge" >            
	                    <i class="fa fa-repeat" ></i>元に戻す
	                  </a>
