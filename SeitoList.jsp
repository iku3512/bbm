 ...
 <!-- Tell the browser to be responsive to screen width -->
  ...
  <body class="hold-transition skin-green sidebar-mini">
     ...
     <!-- Logo -->
	  ...
	  while(rs.next()){
		%>
                      ...
                      <td><a href="/BBM/LeftSeito.jsp?seitoID=<%=rs.getString("seitoID")%>" class="btn btn-default btn-xs"><b>退塾</b></a></font></td>
	...
	%>
          ...
          <a class="btn btn-app"href="./LeftSeitoList.jsp">      
	                    <i class="fa fa-users" ></i> 退塾生徒リスト
	                  </a>
