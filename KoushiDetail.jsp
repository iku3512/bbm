    ...
    <header class="main-header">
     <!-- Logo -->
        ...
        <div class="content-wrapper">
            ...
            <p>　　<a type="button" class="btn btn-default btn-sm" href="/BBM/KoushiList.jsp"><b>戻る</b></a></p>
	  ...
	  while(rs.next()){
		...
		%>  
                  ...
                  <br>
                  <h3 class="profile-username text-center"><strong><%=rs.getString("kname")%></strong></h3>
                  
                 
                   <ul class="list-group list-group-unbordered">
                    <li class="list-group-item">
                      <b>性別</b> <p class="pull-right"><%=rs.getString("ksex")%></p>
                    </li>
                      <li class="list-group-item">
                      <b>担当授業</b> <p class="pull-right"><%=rs.getString("ktype")%></p>
                    </li>
                    
                    <li class="list-group-item">
                      <b>特記</b> <br><br><p class="pull-right"><%=rs.getString("knaiyo")%></p>
                   <br><br><br><br>
                    </li>
                  </ul>
                            </div>
                ...
                <tbody>
                 <tr>
                     <th width="100" class="warning">講師氏名</th>
                    <td width="200"><%=rs.getString("kname")%></td>
                    <th width="110" class="warning">フリガナ</th>
              ...
              <table class="table table-bordered">
                <tbody>
                  <tr>
                    ...
                    <th width="100" class="warning">住所</th>
                    <td width="700"><%=rs.getString("khome")%></td></tr>
                 </tbody></table>
                 
               <table class="table table-bordered">
                <tbody>
                   <tr>
                      <th width="100" class="warning">学校</th>
                    <td width="200"><%=rs.getString("kschool")%></td>
                    <th width="110" class="warning">学年</th>
                    <td ><%=rs.getString("kage")%></td></tr>
                 </tbody></table>
                ...
                <tbody>
                 <tr>
                     <th width="100" class="warning">TEL (携帯)</th>
                    <td width="200"><%=rs.getString("ktel")%></td>
                    <th width="110" class="warning">TEL (自宅)</th>
                    <td><%=rs.getString("ktel2")%></td>
                 </tr>
               ...
               <table class="table table-bordered">
                <tbody>
                 <tr>
                     <th width="100" class="warning">MAIL</th>
                    <td width="200"><%=rs.getString("kmail")%></td>
