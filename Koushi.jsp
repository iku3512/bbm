  ...
  <body class="hold-transition skin-green sidebar-mini">
    ...
    <!-- =============================================== -->
        ...
        <section class="content">
            <div class="row">
                <div class="col-xs-12">
                   <form method="post" action="./KoushiServlet" class="form-horizontal" autocomplete="off">
                            ...
                            <div class="box-body">
                                ...
                                <br>
                                  ...
                                  <div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        <div class="row"><div class="col-sm-8"><input type="text" name="kname" class="form-control input-sm" placeholder="（例）　山田　太郎" required/></div></div>
                                 ...
                                 <div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        <div class="row"><div class="col-sm-8"><input type="text" name="kkana"class="form-control input-sm" placeholder="（例）　ヤマダ　タロウ"/></div></div>
                                        <!--<div class="row"><div class="col-sm-10"><p class="form-control-static text-danger"><small>ここにエラーメッセージを表示します</small></p></div></div>-->
                                    </div>
                                </div>
                                 <div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        <div class="row"><div class="col-sm-12">
                                            <div class="radio">
                                                <label><input type="radio" class="flat-red"name="ksex" value="0" checked="checked"/>男</label>　
                                                <label><input type="radio" class="flat-red"name="ksex" value="1"/>女</label>
                                            </div>
                                        </div></div>
                                        <!--<div class="row"><div class="col-sm-10"><p class="form-control-static text-danger"><small>ここにエラーメッセージを表示します</small></p></div></div>-->
                                    </div>
                               ...
                               <br>
                                 <div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        <div class="row"><div class="col-sm-10"><input type="text" name="khome" class="form-control input-sm" placeholder=""/></div></div>
                                        <!--<div class="row"><div class="col-sm-10"><p class="form-control-static text-danger"><small>ここにエラーメッセージを表示します</small></p></div></div>-->
                                    </div>
                                </div>
                                <br>
                                 <div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        <div class="row"><div class="col-sm-4"><input type="text" name="kschool" class="form-control input-sm" placeholder=""/></div></div>
                                        <!--<div class="row"><div class="col-sm-10"><p class="form-control-static text-danger"><small>ここにエラーメッセージを表示します</small></p></div></div>-->
                                    </div>
                                </div>
                                    ...
                                    <div class="col-sm-10">
                                        <div class="row"><div class="col-sm-4">
                                            <select name="kage" class="form-control input-sm">
                                            	<option value="1">大学１年</option>
                                            	<option value="2">大学２年</option>
                                                <option value="3">大学３年</option>
                                                <option value="4">大学４年</option>
                                                <option value="5">院生</option>
                                ...
                                <br>
                                                       ...
                                                       <div class="form-group">
                                    <label for="stel" class="control-label col-sm-2">携帯番号</label>
                                    <div class="col-sm-10">
                                        <div class="row"><div class="col-sm-4"><input type="text" name="ktel" class="form-control input-sm" placeholder="00-0000-0000"/></div></div>
                                        <!--<div class="row"><div class="col-sm-10"><p class="form-control-static text-danger"><small>ここにエラーメッセージを表示します</small></p></div></div>-->
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        <div class="row"><div class="col-sm-4"><input type="text" name="ktel2" class="form-control input-sm" placeholder="00-0000-0000" required/></div></div>
                                        <!--<div class="row"><div class="col-sm-10"><p class="form-control-static text-danger"><small>ここにエラーメッセージを表示します</small></p></div></div>-->
                                    </div>
                                </div>
                                <br>
                                    ...
                                    <div class="col-sm-10">
                                        ...
                                        <i class="fa fa-envelope"></i></span><input type="text" name="kmail" 
               ...
               <br> 
                <div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        <div class="row"><div class="col-sm-12">
                                            <div class="radio">
                                                <label><input type="radio" name="ktype" value="0" checked="checked"/>集団</label>　
                                                <label><input type="radio" name="ktype" value="1"/>個別</label>
                                            </div>
                                        </div></div><br>
                                        <!--<div class="row"><div class="col-sm-10"><p class="form-control-static text-danger"><small>ここにエラーメッセージを表示します</small></p></div></div>-->
                                    </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        <div class="row"><div class="col-sm-12"><textarea rows="5" name="knaiyo" class="form-control input-sm" placeholder="得意科目等"></textarea></div></div>
                                        <!--<div class="row"><div class="col-sm-10"><p class="form-control-static text-danger"><small>ここにエラーメッセージを表示します</small></p></div></div>-->
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="box-footer">
                                <div class="text-center">
                                    ...
                                    <button type="submit" id="send" value="新規登録" class="btn btn-warning">登録</button>
