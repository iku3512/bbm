...
+ "SET age = (CASE WHEN age = '小学６年' THEN '中学１年' WHEN age = '小学４年' THEN '小学５年'"
+" WHEN age = '小学５年' THEN '小学６年' WHEN age = '中学１年' THEN '中学２年'"
+" WHEN age = '中学２年' THEN '中学３年' WHEN age = '中学３年' THEN '退塾'"
+" WHEN age = '退塾' THEN '退塾' WHEN age = '高校生' THEN '高校生' end)";
