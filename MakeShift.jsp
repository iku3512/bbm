 ...
 <!-- Tell the browser to be responsive to screen width -->
  ...
  <body class="hold-transition skin-green sidebar-mini">
     ...
     <!-- Logo -->
        ...
        <div class="content-wrapper">
            ...
            <section class="content-header">
                <h1><a type="button" class="btn btn-default btn-sm" href="/BBM/Shift.jsp"><b>戻る</b></a>
                </h1>
    ...
    <!-- =============================================== -->
            ...
            <div class="row">
                <div class="col-xs-12" >
                   <form method="post" action="./ShiftMonth" class="form-horizontal" autocomplete="off">
                        <!--<div class="callout callout-danger">-->
                            <!--<p>共通エラーメッセージ表示エリア</p>-->
                        <!--</div>-->
                        <div class="box box-info">
                         <div class="box-header">
                                <h3 class="box-title">シフト作成</h3>
                            </div>
                            <div class="box-body">
                                <br>
                                <div class="form-group">
                                    <label for="htel" class="control-label col-sm-2"></label>
                                    <div class="col-sm-10">
                                        <div class="row"><div class="col-sm-10"><h4><i class="fa fa-calendar-minus-o"></i> 作成したい月を選択して下さい。</h4><br>
                                        <select name="smonth" class="btn btn-dafault btn-lg" onChange="top.location.href=value">
                                            	<option value="" ></option>
                                            	<option value="./ShiftInsert.jsp?smonth=1">１月</option>
                                            	<option value="./ShiftInsert.jsp?smonth=2">２月</option>
                                                <option value="./ShiftInsert.jsp?smonth=3">３月</option>
                                                <option value="./ShiftInsert.jsp?smonth=4">４月</option>
                                                <option value="./ShiftInsert.jsp?smonth=５月">５月</option>
                                                <option value="./ShiftInsert.jsp?smonth=６月">６月</option>
                                                <option value="./ShiftInsert.jsp?smonth=７月">７月</option>
                                                <option value="./ShiftInsert.jsp?smonth=８月">８月</option>
                                                <option value="./ShiftInsert.jsp?smonth=９月">９月</option>
                                                <option value="./ShiftInsert.jsp?smonth=１０月">１０月</option>
                                                <option value="./ShiftInsert.jsp?smonth=１１月">１１月</option>
                                                <option value="./ShiftInsert.jsp?smonth=１２月">１２月</option>
                                            </select>
