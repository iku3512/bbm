     ...
     <!-- Logo -->
      ...
      <!-- Content Wrapper. Contains page content -->
        ...
        <div class="col-md-3 col-sm-6 col-xs-12">
              <div class="info-box">
                <a href="/BBM/MakeShift.jsp" class="info-box-icon bg-aqua"><span class="glyphicon glyphicon-plus"></span></a>
                <div class="info-box-content">
                  <span class="info-box-text text-muted">Making　Schedules</span>
                  <a href="/BBM/MakeShift.jsp" class="info-box-number text-black">シフト作成</a>
                </div><!-- /.info-box-content -->
              </div><!-- /.info-box -->
            </div><!-- /.col -->
            <div class="col-md-3 col-sm-6 col-xs-12">
              <div class="info-box">
                <a href="/BBM/pages/ShiftCalendar.jsp" class="info-box-icon bg-red"><span class="glyphicon glyphicon-calendar"></spanzs></a>
                <div class="info-box-content">
                  <span class="info-box-text text-muted">Time schedules</span>
                  <a href="/BBM/pages/ShiftCalendar.jsp" class="info-box-number text-black">シフト照会</a>
                </div><!-- /.info-box-content -->
              </div><!-- /.info-box -->
            </div><!-- /.col -->
          </div><!-- /.row -->
