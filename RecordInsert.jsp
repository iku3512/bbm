     ...
     <!-- Logo -->
        ...
        <div class="content-wrapper">
            ...
            <section class="content-header">
                <h1><a type="button" class="btn btn-default btn-sm" href="/BBM/Record.jsp"><b>戻る</b></a>
                </h1>
	  ...
	  while(rs.next()){
		...
		%>  
              ...
              <!-- /.box-header -->
                ...
                <form method="post" action="./RecordServlet?sname=<%=rs.getString("sname")%>" class="form-horizontal" autocomplete="off">
                  ...
                  <table class="table table-hover">
                    ...
                    <td><input type='text' name="sname" value="<%=rs.getString("sname")%>" disabled></td>
                    
                    
                     <td><select name="age" class="btn btn-default btn">
                           <option value="中学１年">中学１年</option>
                           <option value="中学２年">中学２年</option>
                           <option value="中学３年">中学３年</option>
                      </select></td>
                     
                      <td><input type="radio" name="semester" value="１学期" checked>１学期
						　<input type="radio" name="semester" value="学年末">学年末</td>
                      
                      <td><select name="kokugo" class="btn btn-default btn">
                     ...
                     <td><select name="syakai" class="btn btn-default btn">
                           <option value="1">1</option>
                           <option value="2">2</option>
                           <option value="3">3</option>
                           <option value="4">4</option>
                    ...
                    <td><select name="sugaku" class="btn btn-default btn">
                           <option value="1">1</option>
                           <option value="2">2</option>
                           <option value="3">3</option>
                           <option value="4">4</option>
                    ...
                    <td><select name="rika" class="btn btn-default btn">
                           <option value="1">1</option>
                           <option value="2">2</option>
                           <option value="3">3</option>
                           <option value="4">4</option>
                      ...
                      <td><select name="ongaku" class="btn btn-default btn">
                           <option value="1">1</option>
                           <option value="2">2</option>
                           <option value="3">3</option>
                           <option value="4">4</option>
                      ...
                      <td><select name="bijutu" class="btn btn-default btn">
                           <option value="1">1</option>
                           <option value="2">2</option>
                           <option value="3">3</option>
                           <option value="4">4</option>
                      ...
                      <td><select name="taiku" class="btn btn-default btn">
                           <option value="1">1</option>
                           <option value="2">2</option>
                           <option value="3">3</option>
                           <option value="4">4</option>
                      ...
                      <td><select name="gika" class="btn btn-default btn">
                           <option value="1">1</option>
                           <option value="2">2</option>
                           <option value="3">3</option>
                           <option value="4">4</option>
                      ...
                      <td><select name="eigo" class="btn btn-default btn">
                           <option value="1">1</option>
                           <option value="2">2</option>
                           <option value="3">3</option>
                           <option value="4">4</option>
                     ...
                     <td></td>
                        ...
                        <center><button type="submit"class="btn bg-olive btn-large"><b>登録</b></button></center>
