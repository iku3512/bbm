     ...
     <!-- Logo -->
        ...
        <div class="content-wrapper">
            ...
            <section class="content-header">
                <h1>明細照会　<a type="button" class="btn btn-default btn-sm" href="/BBM/WorkTime.jsp"><b>戻る</b></a></h1>
                ...
                <div class="box-body table-responsive no-padding">
                  <table class="table table-hover table-striped">
                    ...
                    　<th class="active">　</th>
                      ...
                      <th class="active">　</th>
                      <th class="active">出退勤履歴</th>
                       <th class="active">給料明細</th>
                       <th class="active">　</th>
                    </tr>
	  ...
	  ResultSet rs=objSql.executeQuery("SELECT * FROM koushi_list where kage not in ('退塾')");
	  ...
	  while(rs.next()){
		...
		%>
                     ...
                     <td>　</td>
                      <td><a href="/BBM/WorkOld.jsp?kname=<%=rs.getString("kname")%>" class="btn bg-olive btn-large btn-flat"><b>履歴</b></a></font></td>
                      <td><a href="/BBM/SetTotalPrice?koushiID=<%=rs.getString("koushiID")%>" class="btn bg-teal btn-large btn-flat"><b>明細</b></a></font></td>
       					<td>　</td>
                    </tr>
	   <%
	}
